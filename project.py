...
print(os.listdir("C:/Users/hossam/RWMFD"))

img = cv2.imread('C:/Users/hossam/RWMFD/test/mbappe2.jpg')
...
filename = 'C:/Users/hossam/RWMFD/test/Aaron_Peirsol_0003.jpg'
# load image from file
...
# pixels = extract_face("C:/Users/hossam/RMFD/test/0_0_caiguoqing_0001.jpg")
pixels = extract_face('C:/Users/hossam/RWMFD/test/0_0_0.jpg')
plt.imshow(pixels)
plt.show()
print(pixels.shape)
...
# load train dataset
#trainX, trainy = load_dataset ('C:/Users/hossam/RWMFD/train' )
#print (trainX.shape, trainy.shape)

# load test dataset
#testX, testy = load_dataset('C:/Users/hossam/RWMFD/val')
...
model2 = load_model('C:/Users/hossam/.keras/models/vggface/facenet_keras1.h5')
...
random_face = extract_face('C:/Users/hossam/RWMFD/test/0_0_1.jpg')
...
if (class_probability <10):
    ...
    # print("inside if")
    title = 'predicted: %s          Expected: %s' % (predict_names[0],predict_names[0])
plt.title(title)
plt.show()
